import {setFormValue, submitSignInForm, submitSignUpForm, validateEmail, validatePassword} from "./utils.js"
...
password.oninput = (e) => setFormValue(password_id, e.target.value, validatePassword(e))
